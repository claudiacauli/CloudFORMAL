...
import aws.cfn.specifications.Specification

import scala.language.postfixOps


protected sealed trait IntrinsicFunction extends CloudFormationFunction


protected final case class Base64Function()
...
protected final case class CidrFunction()
  extends IntrinsicFunction
...
protected final case class FindInMapFunction
...
protected final case class GetAttFunction ( optRE: Option[Json2ResourceEncoder],
...
protected final case class GetAZsFunction() extends
  IntrinsicFunction
...
protected final case class ImportValueFunction( tE: Json2TemplateEncoder,
...
protected final case class JoinFunction()
  extends IntrinsicFunction
...
protected final case class SelectFunction(optRE:Option[Json2ResourceEncoder])
  extends IntrinsicFunction
...
protected final case class SplitFunction()
  extends IntrinsicFunction
...
protected final case class SubFunction (optRE: Option[Json2ResourceEncoder],
                              tE: Json2TemplateEncoder)
  extends IntrinsicFunction
...
protected final case class TransformFunction()
  extends IntrinsicFunction
{
...
protected final case class RefFunction(optRE: Option[Json2ResourceEncoder],
                             tE: Json2TemplateEncoder)
...
protected sealed trait ConditionFunction
  extends IntrinsicFunction


  protected final case class IfFunction()
...
protected sealed trait BooleanFunction
  extends ConditionFunction


  protected final case class AndFunction()
  ...
  protected final case class OrFunction()
    extends BooleanFunction
      with ((BooleanNode,BooleanNode) => BooleanNode)
  {
    def apply(e1: BooleanNode, e2: BooleanNode): BooleanNode =
  ...
  protected final case class NotFunction()
    extends BooleanFunction
  ...
  protected final case class EqualsFunction()
    extends BooleanFunction
