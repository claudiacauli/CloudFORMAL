...
object DLModelWriter {
    ...
    val permissionFileSuffix        = "_PermissionModel.owl"
    ...
    def writePermissionToOutputFolder(model:DLModel, outputDir:String, format:String = "rdf"): Unit = {

        val folderName = outputDir+model.name
        val fileName = folderName + "/" + model.name + permissionFileSuffix
